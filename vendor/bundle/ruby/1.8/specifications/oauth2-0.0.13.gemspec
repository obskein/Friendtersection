...
Gem::Specification.new do |s|
  ...
  s.files = [".document", ".gitignore", "CHANGELOG.rdoc", "LICENSE", "README.rdoc", "Rakefile", "VERSION", "lib/oauth2.rb", "lib/oauth2/access_token.rb", "lib/oauth2/client.rb", "lib/oauth2/response_hash.rb", "lib/oauth2/response_string.rb", "lib/oauth2/strategy/base.rb", "lib/oauth2/strategy/web_server.rb", "oauth2.gemspec", "spec/oauth2/access_token_spec.rb", "spec/oauth2/client_spec.rb", "spec/oauth2/strategy/base_spec.rb", "spec/oauth2/strategy/web_server_spec.rb", "spec/spec.opts", "spec/spec_helper.rb", "specs.watchr"]
